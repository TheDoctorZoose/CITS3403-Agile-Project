...
class TestGameEntrySubmission(TestBase):
    ...
    def test_submit_game_entry_with_multiple_players(self, app, client):
        ...
        response = client.post('/forum', data={
            ...
            'first_time_playing': ['1', '1']  # Both players played for the first time
        })
        ...
        with app.app_context():
            ...
            self.assertEqual(2, len(entries), "Expected there to be two entries for two players.")  # Two players, two entries
